//
//  TeritaryVerticalBothButtonCollectionViewCell.swift
//  tellingMe
//
//  Created by 마경미 on 04.04.23.
//

import UIKit

class TeritaryVerticalBothButtonCell: UICollectionViewCell {
    static let id = "teritaryVerticalBothButtonCell"
    ...
    func setData(with data: TeritaryBothData) {
        self.setImageandLabel(imgName: data.imgName, text: data.title)
        self.backgroundColor = UIColor(named: "Side200")
