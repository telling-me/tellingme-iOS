//
//  TellingEBookViewController.swift
//  tellingMe
//
...
final class TellingEBookViewController: UIViewController {
...
extension TellingEBookViewController {
    ...
    private func setStyles() {
        ...
        backgroundView.do {
            $0.backgroundColor = .EBookNavigationColor
        }
        
        navigationBarView.do {
            $0.setColor(with: .EBookNavigationColor)
            $0.setTitle(with: "텔링e북")
        }
        ...
        informationImageView.do {
            $0.image = UIImage(named: "TellingEBookInfo")
            $0.contentMode = .scaleAspectFill
            $0.layer.masksToBounds = true
        }
        
        readyButton.setTitleFor("텔링e북을 준비 중이에요!")
    }
...
extension TellingEBookViewController {
    private func getHeightOfScrollView() -> CGFloat {
        guard let appDelegate = UIApplication.shared.delegate as? AppDelegate else { return 1142 }
        return appDelegate.deviceWidth * 3.04
    }
}
