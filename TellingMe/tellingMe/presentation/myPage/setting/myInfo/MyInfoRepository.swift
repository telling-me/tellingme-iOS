...
extension MyInfoViewController {
    ...
    func updateUserInfo() {
        let request = UpdateUserInfoRequest(birthDate: viewModel.year, gender: viewModel.gender, job: viewModel.job, jobInfo: viewModel.jobInfo, mbti: viewModel.mbti, nickname: viewModel.nickname, purpose: viewModel.purpose.sorted().intArraytoString())
